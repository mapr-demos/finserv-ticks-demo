...
public class ConsumeWithOffsets {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args.length < 1) {
            ...
            System.err.println("USAGE:\n" +
                    "\tjava -cp `mapr classpath`:./nyse-taq-streaming-1.0-jar-with-dependencies.jar com.mapr.test.ConsumeWithOffsets stream:topic1 [stream:topic_n] [verbose]\n" +
                    "EXAMPLE:\n" +
                    "\tjava -cp `mapr classpath`:./nyse-taq-streaming-1.0-jar-with-dependencies.jar com.mapr.test.ConsumeWithOffsets /user/mapr/taq:test01 /user/mapr/taq:test02 /user/mapr/taq:test03 verbose");
        }
                    ...
                    for (ConsumerRecord<String, byte[]> record : records) {
                        ...
                        if (record.key() != null) {
                            if (VERBOSE) {
                                ...
                                cal.setTimeInMillis(Long.parseLong(new String(record.key())));
